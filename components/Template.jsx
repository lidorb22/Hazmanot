...
function Template({
  ...
  return (
    <motion.div
      ...
      className="opacity-0 absolute top-0 left-0 h-full w-full bg-black bg-opacity-70 z-50 flex justify-center items-center 2xl:row-start-1 2xl:row-span-6 2xl:bg-transparent 2xl:static"
    >
      <motion.div
        ...
        className={`relative h-5/6 w-[300px] rounded-xl flex flex-col items-center justify-center space-y-4 2xl:h-[650px]`}
      >
