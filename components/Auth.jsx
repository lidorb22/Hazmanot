    ...
    >
      ...
      {error && (
        <motion.div
          ...
          className="flex flex-row items-center justify-center col-start-1 row-start-4 w-72 rounded-lg justify-self-center h-10 self-end mb-14 border-2 border-black bg-red-600"
        >
          <motion.p
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
