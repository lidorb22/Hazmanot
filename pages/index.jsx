...
export default function Home() {
  ...
  return (
    <div
      className={`${
        innerHeight && isMobile
          ? `h-[${innerHeight.toString() + "px"}] bg-black`
          : "h-screen"
